import { FaLinkedin, FaGithub, FaDiscord, FaKaggle } from "react-icons/fa";
import { motion } from "framer-motion";
import { Button } from "@/components/ui/button";
import { HiOutlineSparkles } from "react-icons/hi";

const socials = [
  { icon: <FaLinkedin />, path: "https://www.linkedin.com/in/alaa-harb7/" },
  { icon: <FaGithub />, path: "https://github.com/alaa-harb7" },
  { icon: <FaKaggle />, path: "https://www.kaggle.com/alaaharb7" },
];
