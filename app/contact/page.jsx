...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+1) 102 296-3742",
    action: () => (window.location.href = "tel:+201022963742"),
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "alaaharbofficial@gmail.com",
    action: () => (window.location.href = "mailto:alaaharbofficial@gmail.com"),
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Location",
    description: "Beheira, Egypt",
    action: () =>
      window.open(
        "https://www.google.com/maps/search/Beheira,+Egypt",
        "_blank",
      ),
  },
];
